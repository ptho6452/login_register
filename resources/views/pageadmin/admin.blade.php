	...
	        <th scope="col">New</th>															
	        <th scope="col"><a href="/add/" class="btn btn-primary" style="width:80px;">Add</a></th>															
	      </tr>															
	    </thead>															
	    <tbody>															
	...
	        <td>{{$product->new}}</td>															
	        <td>															
	          <a href='/edit/{{$product->id}}' type="submit" class="btn btn-warning" style="width:80px;">Edit</a>															
